...
static const _Order_Request_type_support_symbol_names_t _Order_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, b4_serv_robot_interface, srv, Order_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, b4_serv_robot_interface, srv, Order_Request)),
  }
};
...
{
  return &::b4_serv_robot_interface::srv::rosidl_typesupport_cpp::Order_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, b4_serv_robot_interface, srv, Order_Request)() {
  return get_message_type_support_handle<b4_serv_robot_interface::srv::Order_Request>();
}
...
static const _Order_Response_type_support_symbol_names_t _Order_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, b4_serv_robot_interface, srv, Order_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, b4_serv_robot_interface, srv, Order_Response)),
  }
};
...
{
  return &::b4_serv_robot_interface::srv::rosidl_typesupport_cpp::Order_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, b4_serv_robot_interface, srv, Order_Response)() {
  return get_message_type_support_handle<b4_serv_robot_interface::srv::Order_Response>();
}
...
static const _Order_type_support_symbol_names_t _Order_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, b4_serv_robot_interface, srv, Order)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, b4_serv_robot_interface, srv, Order)),
  }
};
...
{
  return &::b4_serv_robot_interface::srv::rosidl_typesupport_cpp::Order_service_type_support_handle;
}
