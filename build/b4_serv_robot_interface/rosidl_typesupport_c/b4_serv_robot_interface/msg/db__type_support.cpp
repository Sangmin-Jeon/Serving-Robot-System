...
static const _DB_type_support_symbol_names_t _DB_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, b4_serv_robot_interface, msg, DB)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, b4_serv_robot_interface, msg, DB)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, b4_serv_robot_interface, msg, DB)() {
  return &::b4_serv_robot_interface::msg::rosidl_typesupport_c::DB_message_type_support_handle;
}
